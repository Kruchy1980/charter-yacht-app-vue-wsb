<template>
  <div id="userAccount">
    ...
    <main v-show="isLoggedUser" class="container">
      <div class="user__section text__color--dark background__color--light">
        <button class="user__section__button" @click.stop="showUserContainer($event)">
          Twoje konto
          <i class="fas fa-caret-down hide show" />
          <i class="fas fa-caret-up hide" />
        </button>
    ...
    <UserChangeName
      v-show="isUserChangeName"
      @close="isUserChangeName=!isUserChangeName"
      @changeName="changeUserName"
    />
    <UserChangeMail
      v-show="isUserChangeMail"
      @close="isUserChangeMail=!isUserChangeMail"
      @changeMail="changeUserMail"
    />
    <UserChangePass
      v-show="isUserChangePass"
      @close="isUserChangePass=!isUserChangePass"
      @changePass="changeUserPass"
    />
    <UserDeleteAccount
      v-show="isUserDeleteAccount"
      @close="isUserDeleteAccount=!isUserDeleteAccount"
