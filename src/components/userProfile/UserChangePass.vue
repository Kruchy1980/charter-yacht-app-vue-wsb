...
export default {
    ...
    methods: {
        ...
        changePass(){
            ...
            let newPass = this.$refs['createPassword'];
            let newPass2 = this.$refs['createPassword2'];
            let mail = this.$refs['loginEmail'];
            let oldPass = this.$refs['loginPassword'];
            let controls = [newPass,newPass2,mail,oldPass];
            ...
            if(valid){
                this.$emit('changePass',newPass.value,mail.value,oldPass.value);
            }
        },
    },
}
