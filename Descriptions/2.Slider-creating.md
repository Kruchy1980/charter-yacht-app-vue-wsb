...
### Adding arrows to the Sleder - in TheSlider.vue component:
...
**SCRIPT - we need to add some logic to the arrows:**
...
**Adding the choice dots to our photos - go to TheSlider.vue:**
**In the template on the bottom part we add:**
...
**And in sctipt we need to add method which will assign the indicator to the photo:**
**In methods swe are adding a method:**
